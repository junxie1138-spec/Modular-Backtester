...
class GeneratedStrategy(BaseStrategy[GeneratedParams]):
    ...
    def generate_signals(
        ...
        # WRONG: signal dtype must be int. Cast to float on purpose to trip Tier 2.
        df["signal"] = raw_signal.astype(float)
        # placeholder .shift(1) so Tier 1's substring check still passes; this
        # fixture exists to exercise Tier 2's dtype check.
        df["size"] = params.size
